  ...
  return (
    <div className="container-custom py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/login?mode=login" className="group block rounded-2xl border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800 hover:shadow-md transition">
        ...
        <Link href="/login?mode=signup" className="group block rounded-2xl border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800 hover:shadow-md transition">
